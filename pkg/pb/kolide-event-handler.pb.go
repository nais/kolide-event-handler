...
func file_pkg_pb_kolide_event_handler_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_pb_kolide_event_handler_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_pb_kolide_event_handler_proto_msgTypes[1].Exporter = func(v any, i int) any {
